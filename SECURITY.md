...
- [release/4.1.x](https://github.com/swiyu-admin-ch/swiyu-issuer/tree/release/4.1.x)

Vulnerabilities affecting any other branches, older tags, forks and code are out of scope unless explicitly announced as
included.

The configurations listed in [EXPERIMENTAL.md](https://github.com/swiyu-admin-ch/swiyu-issuer/blob/main/EXPERIMENTAL.md)
are considered experimental and are excluded from the scope of the program.
