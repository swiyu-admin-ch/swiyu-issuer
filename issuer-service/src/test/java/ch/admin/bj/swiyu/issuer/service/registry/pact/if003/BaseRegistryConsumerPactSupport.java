package ch.admin.bj.swiyu.issuer.service.registry.pact.if003;
...
final class BaseRegistryConsumerPactSupport {
    ...
    static DidKeyResolverFacade buildDidKeyResolver(final MockServer mockServer) {
        ...
        return new DidKeyResolverFacade(adapter, urlRewriteProperties);
    }
}
