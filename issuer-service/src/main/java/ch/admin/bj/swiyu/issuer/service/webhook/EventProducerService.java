...
public class EventProducerService {
    ...
    public void produceOfferStateChangeEvent(UUID credentialManagementId, UUID credentialOfferId, CredentialOfferStatusType state) { // TODO@MP verify that all calls to this function, are actually offer state changes
