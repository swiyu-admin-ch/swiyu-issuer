# Migration Guide: v2.4.x → v3.0.x

This guide helps you migrate from **v2.4.x** to **v3.0.x** of the Generic Issuer Service.

It is based on the **v3.0.x** section in `CHANGELOG.md`
...
- `CHANGELOG.md` → section: `latest (3.0.x)`