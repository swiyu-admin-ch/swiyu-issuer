package ch.admin.bit.swiyu.issuer.management;

import ch.admin.bit.swiyu.issuer.management.config.StatusListProperties;
import ch.admin.bit.swiyu.issuer.management.infrastructure.web.controller.CredentialsController;
    ...
    void dummyTest() throws JOSEException {
        ...
        try {
            ...
            JWTClaimsSet claims = new JWTClaimsSet.Builder()
                    ...
                    .build();
            SignedJWT jwt = new SignedJWT(new JWSHeader.Builder(JWSAlgorithm.ES256).keyID(ecJWK.getKeyID()).build(), claims);
            jwt.sign(signer);
