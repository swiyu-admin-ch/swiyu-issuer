...
public class CredentialOfferCreateIt extends BaseIt {
    ...
    void testCreateOffer_thenSuccess() throws Exception {
        ...
        String minPayloadWithValidUntil= String.format("{\"metadata_credential_supported_id\": \"%s\", \"credential_subject_data\": {}, \"credential_valid_until\" : \"2010-01-01T19:23:24Z\"}", RandomStringUtils.random(10));
