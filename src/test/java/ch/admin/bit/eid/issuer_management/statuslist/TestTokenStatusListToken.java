...
package ch.admin.bit.eid.issuer_management.statuslist;
...
public class TestTokenStatusListToken {
    ...
    void testCreateNewStatusList_thenSuccess() throws DataFormatException, IOException {
        ...
        */
        // Create an empty token status list like in 9.1 of https://www.ietf.org/archive/id/draft-ietf-oauth-status-list-02.html#name-further-examples
        ...
        */
        ...
        Assertions.assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(() -> {statusList.setStatus(11, 4);});
        ...
        var statusListLoaded = TokenStatusListToken.loadTokenStatusListToken((int) claims.get("bits"), (String) claims.get("lst"));
        for (int i = 0; i < 12; i++) {
