...
import ch.admin.bit.swiyu.issuer.management.service.StatusListService;
...
public class StatusListController {
    ...
    @PostMapping("")
    @Operation(summary = "Initialize a new status list.",
            description = "Initialize and link a status list slot to to this service. " +
