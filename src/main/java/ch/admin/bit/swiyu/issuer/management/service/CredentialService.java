...
import ch.admin.bit.swiyu.issuer.management.api.dto.CreateCredentialRequestDto;
import ch.admin.bit.swiyu.issuer.management.api.dto.CredentialOfferDto;
...
import ch.admin.bit.swiyu.issuer.management.domain.credential_offer_status.CredentialOfferStatusKey;
import ch.admin.bit.swiyu.issuer.management.domain.credential_offer_status.CredentialOfferStatusRepository;
...
import ch.admin.bit.swiyu.issuer.management.exception.ResourceNotFoundException;
...
import static ch.admin.bit.swiyu.issuer.management.domain.credential_offer.CredentialOfferEntity.readOfferData;
...
public class CredentialService {
    ...
    public CredentialOfferEntity createCredential(CreateCredentialRequestDto requestDto) {
        ...
        if (statusLists.size() != requestDto.getStatusLists().size()) {
            throw new BadRequestException(String.format("Could not resolve all provided status lists, only found %s", statusLists.stream().map(StatusListEntity::getUri).collect(Collectors.joining(", "))));
        }
