...
public class CredentialService {
    ...
    public CredentialOfferEntity getCredential(UUID credentialId) {
        ...
        return Optional.of(this.credentialOfferRepository.getReferenceById(credentialId))
    ...
    public CredentialOfferEntity updateCredentialStatus(UUID credentialId, CredentialStatusEnum status) {
