...
class MonitoringSecurityConfigTest {
    ...
    @Test
    void prometheus_whenBasicAuthMissing_thenUnauthorized() {
        assertDoesNotThrow(() -> mvc.perform(get(PROMETHEUS_ENDPOINT))
                .andExpect(status().isUnauthorized()));
    }

    @Test
    void prometheus_whenBasicAuthInvalid_thenUnauthorized() {
        assertDoesNotThrow(() -> mvc.perform(get(PROMETHEUS_ENDPOINT)
    ...
    @Test
    void prometheus_whenBasicAuthValid_thenRequestPassesAuthorization() {
        assertDoesNotThrow(() -> mvc.perform(get(PROMETHEUS_ENDPOINT)
