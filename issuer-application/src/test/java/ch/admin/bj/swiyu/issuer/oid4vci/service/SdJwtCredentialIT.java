...
class SdJwtCredentialIT {
    ...
    void getMinimalSdJwtCredentialTestClaims_thenSuccess() {
        ...
        var vc = vcFormatFactory
                ...
                .credentialResponseEncryption(encryptionJweService.issuerMetadataWithEncryptionOptions().getResponseEncryption(), credentialRequest.getCredentialResponseEncryption())
